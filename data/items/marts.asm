...
BaseShopText::
	script_mart POTION, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, AWAKENING, ICE_HEAL, REVIVE, ETHER

BaseShop2Text::
	script_mart SUPER_POTION, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, AWAKENING, ICE_HEAL, REVIVE, ETHER

BaseShop3Text::
	script_mart HYPER_POTION, FULL_HEAL, REVIVE, MAX_ETHER, ELIXER

BaseShop4Text::
	script_mart HYPER_POTION, FULL_HEAL, MAX_REVIVE, MAX_ETHER, ELIXER

IndigoPlateauLobbyClerkText::
	script_mart FULL_RESTORE, MAX_POTION, FULL_HEAL, MAX_REVIVE, MAX_ETHER, MAX_ELIXER
