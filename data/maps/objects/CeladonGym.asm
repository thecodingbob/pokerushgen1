...
CeladonGym_Object:
	...
	object_event  7, 15, SPRITE_GYM_GUIDE, STAY, DOWN, TEXT_CELADONGYM_GYM_GUIDE
	object_event  1, 15, SPRITE_CLERK, STAY, DOWN, TEXT_CELADONGYM_BASE_SHOP
	object_event  2, 15, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_CELADONGYM_VITAMIN_SHOP
