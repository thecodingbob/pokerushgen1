...
PewterGym_Object:
	...
	def_warp_events
	warp_event  4, 13, ROUTE_22, 3
	warp_event  5, 13, ROUTE_22, 3
	...
	object_event  2, 10, SPRITE_CLERK, STAY, DOWN, TEXT_PEWTERGYM_BASE_SHOP
	object_event  1, 10, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_PEWTERGYM_VITAMIN_SHOP
