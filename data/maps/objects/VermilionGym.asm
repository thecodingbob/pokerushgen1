...
VermilionGym_Object:
	...
	object_event  7,  8, SPRITE_CLERK, STAY, LEFT, TEXT_VERMILIONGYM_BASE_SHOP
	object_event  7, 10, SPRITE_LINK_RECEPTIONIST, STAY, LEFT, TEXT_VERMILIONGYM_VITAMIN_SHOP
