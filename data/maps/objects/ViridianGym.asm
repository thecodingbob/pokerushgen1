...
ViridianGym_Object:
	...
	object_event 15, 12, SPRITE_CLERK, STAY, DOWN, TEXT_VIRIDIANGYM_BASE_SHOP
	object_event 17, 12, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_VIRIDIANGYM_VITAMIN_SHOP
